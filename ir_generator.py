...
class IRGenerator:
    ...
    def conv_layer(
        ...
        input_list = list()
        input_list.append(ActivationInfo(input_name, input_shape, output_dtype, "figure",keepdim=True))

        output_list = list()
        output_list.append(ActivationInfo(output_name, output_shape, output_dtype, "figure",keepdim=True))
    ...
    def eltwise_layer(
        ...
        input_list = list()
        input_list.append(ActivationInfo(input_A_name, input_A_shape, "float16", "sequence",keepdim=True))
        input_list.append(ActivationInfo(input_B_name, input_B_shape, "float16", "sequence",keepdim=True))
    ...
    def layernorm_layer(
        ...
        self.all_activation_list.add(ActivationInfo(output_name, output_shape, output_dtype, "sequence"))
        weight_flag = weight is not None
        param_list = list()
        if weight_flag:
